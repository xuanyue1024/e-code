...
public class AiSystemConstant {
    ...
    public static final String SMART_RECOMMENDATIONS = """
           ...
           如果用户提问:有没有什么相关的(题目),你就要先查询班内题目,查找有没有与什么有关的tag或者题目,如果有就推荐,没有就说没有
    ...
    public static final String TITLE_GENERATION = """
            我将给你一个AI的对话内容,请根据对话生成一个简短有吸引力的标题,标题不能超过7个字,不要有多余的解释说明,不要有标点符号,不要有引号,不要有任何格式,直接给出标题内容即可
            """;
    ...
    public static final String EVALUATE_ANSWER_SYSTEM_PROMPT = """
            ...
            看完题目后，进行对比分析，并以此作为响应返回JSON对象与指定结构匹配：
            字段：
