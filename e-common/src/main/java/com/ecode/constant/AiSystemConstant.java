...
public class AiSystemConstant {
    ...
    public static final String SMART_RECOMMENDATIONS = """
           ...
           【输出格式】
           1. 班级列表展示：不要重复询问班级，除非用户要求重选班级，否则保持用户原来给与的班级信息即可
           ...
           ### 完成情况统计（除非user指明要查询所有未完成的题目，否则不要使用此格式）
           - 未完成题目：{未完成数量}/{总题目数量}
           - 涉及知识点：{标签1}、{标签2}...
           ...
           5. 不要在输出中混入查询过程的描述
           6. 保持简洁清晰的表达方式
           7. 除非用户查询未完成的题目，否则不要展示未完成字段，也不要展示未完成的题目情况
           
           请严格遵守上述注意事项，用户说干什么你就执行什么，不要展示多余的内容
